...
void SolveWork() {
	...
	if (globalArgs.dataStructure == "Set") {
        ...
        else if (globalArgs.algoType == "MADEC") solver = new STLSetImplement<set<int>, KDefectiveMADEC>(N);
        ...
        else if (globalArgs.algoType == "MADEC") solver = new BitSetImplement<bitset<16000>, KDefectiveMADEC>(N);
